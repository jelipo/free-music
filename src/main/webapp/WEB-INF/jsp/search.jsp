    ...
    <div class="main">
        <div class="top_bar">
            ...
            <div class="top_bar_main">
                ...
                <div class="top_bar_main_index"
                     onclick="window.open('<%=basePath%>')">首页
                </div>
        ...
        <div class="main_song">
                ...
                <div class="songlist_singlesong">
                    <div class="songlist_singlesong_main  material-ripple material-shadow-1 material-hover ">
                        <div class="songlist_singlesong_main_space">
                            ...
                            <div style="width:30px;height:100%;float:left;"><img src="res/pic/qq.png"
                                                                                 style="width:20px;margin:5px 0px;">
                            </div>
                        ...
                        <div class="songlist_singlesong_main_do"><a href="qq/128downurl?id=000gHU1t2WGfrg"
                                                                    target="_blank"
            ...
            <div class="blewbar">
                ...
                <div class="explain">
                    3.目前只解析出QQ音乐和网易音乐的下载的加密方式，因为本人能力有限，目前只有QQ音乐可以下载无损音乐，网易只能解析出320k的下载链接。一些浏览器（如chrome内核的浏览器，360、qq浏览器、搜狗等很多都是chrome内核）当识别到mp3格式的音乐下载链接时，浏览器会直接自动在线播放，不会调用下载器进行下载(这是浏览器本身的问题，无法解决），这时把正在播放音乐的网页的网址复制进下载器即可。
                </div>
                <div class="explain">4.注意低调使用.</div>
                <div class="declaraction">所有资源属各大网站所有，本站对资源内容不承担任何责任</div>
                <div class="final">© 2016 自由音乐/Powered by LaoCao
                    <script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");
                    document.write(unescape("%3Cspan id='cnzz_stat_icon_1260186749'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s11.cnzz.com/z_stat.php%3Fid%3D1260186749%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script>
                </div>
            </div>
        </div>
    </div>
